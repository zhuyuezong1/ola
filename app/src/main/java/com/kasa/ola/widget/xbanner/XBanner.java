package com.kasa.ola.widget.xbanner;
...
public class XBanner extends RelativeLayout implements XBannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointLeftRightPading = XBannerUtils.dp2px(context, 2);
        mPointTopBottomPading = XBannerUtils.dp2px(context, 7);
...
//            mPlaceholderImg.setScaleType(ImageView.ScaleType.FIT_XY);
            mPlaceholderImg.setScaleType(ImageView.ScaleType.CENTER);
