    ...
    public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            if (url.startsWith(BridgeUtil.YY_RETURN_DATA)) { // 如果是返回数据
                ...
                return this.onCustomShouldOverrideUrlLoading(url)?true:super.shouldOverrideUrlLoading(view, (com.tencent.smtt.export.external.interfaces.WebResourceRequest) request);
            }
        }else {
            return super.shouldOverrideUrlLoading(view, (com.tencent.smtt.export.external.interfaces.WebResourceRequest) request);
        }
    }
