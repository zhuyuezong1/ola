...
public class AmountView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public void setFocusable(boolean focusable) {
        ...
        etAmount.setFocusable(isFocusable);
    }
...
//                etAmount.setText(amount + "");
            ...
            if (onEditTextClickListener!=null){
                onEditTextClickListener.onEditTextClick(etAmount);
                return;
            }
        }
        //清除焦点
...
//        }
    ...
    public int getAmount(){
        return TextUtils.isEmpty(etAmount.getText().toString().trim())?0: Integer.parseInt(etAmount.getText().toString().trim());
    }
