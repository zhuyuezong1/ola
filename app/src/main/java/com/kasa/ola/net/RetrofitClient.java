...
public class RetrofitClient {
    ...
    public static String baseUrl = Const.DEBUG ? Const.API_HOST_DEBUG : Const.API_HOST;
...
//    }
    ...
    public void post(String url, RequestBody jsonStr, BaseSubscriber<ResponseBody> subscriber) {
...
//    }
    ...
    public void upload(String url, Map<String, RequestBody> maps, BaseSubscriber<ResponseBody> subscriber) {
        apiService.upLoadFile(url, maps)
                .compose(schedulersTransformer())
//                .compose(transformer())
                .subscribe(subscriber);
    }
