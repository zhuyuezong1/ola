 ...
 */
public class CornerBtnFilterPopWindow extends PopupWindow implements View.OnClickListener {
    ...
    public CornerBtnFilterPopWindow(Activity activity, long startTime, long endTime) {
        ...
        rootView = LayoutInflater.from(activity).inflate(R.layout.view_corner_btn_filter_pop, null);
