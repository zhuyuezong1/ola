...
//        }
    ...
    private void initView() {
        ...
        final boolean haveNoPermission = checkPermissions(LaunchADActivity.this, new String[]{
                Manifest.permission.READ_EXTERNAL_STORAGE,
                Manifest.permission.WRITE_EXTERNAL_STORAGE,
                Manifest.permission.CALL_PHONE});

        if (LoginHandler.get().getShowPrivateRule()) {
            PrivateDialog.Builder builder = new PrivateDialog.Builder(LaunchADActivity.this);
...
//            commonEnter();
            ...
            PermissionDialog.Builder builder = new PermissionDialog.Builder(LaunchADActivity.this);
    ...
    private void getPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            requestPermissions(LaunchADActivity.this, new String[]{
                    Manifest.permission.READ_EXTERNAL_STORAGE,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE,
...
//                    commonEnter();
    ...
    private void getAd() {
        fetchSplashAD(LaunchADActivity.this, splashContainer, skipView, getPosId(), new SplashADListener() {
            @Override
            ...
            public void onNoAD(AdError error) {
                ...
                mHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        ToastUtils.showLongToast(LaunchADActivity.this,str);
                    }
                });
                ...
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (needStartDemoList) {
                            LaunchADActivity.this.startActivity(new Intent(LaunchADActivity.this, MainActivity.class));
                        }
...
//                    Intent intent = new Intent(SplashADActivity.this, GuideActivity.class);
//                    intent.putExtra(Const.GUIDE_LIST_TAG, list);
    ...
    private void getBaseUrl() {
        ApiManager.get().getData(Const.GET_BASE_URL, null, new BusinessBackListener() {
            ...
            public void onBusinessError(int code, String msg) {
                ToastUtils.showShortToast(LaunchADActivity.this, msg);
            }
        }, null);
    }
