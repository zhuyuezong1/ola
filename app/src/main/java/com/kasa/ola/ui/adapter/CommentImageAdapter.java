...
public class CommentImageAdapter extends RecyclerView.Adapter {
    ...
    public CommentImageAdapter(Context context, List<UserViewInfo> list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        int width = DisplayUtils.getScreenWidth(context) - DisplayUtils.dip2px(context, 20) * 2;
...
//                    ToastUtils.showLongToast(context,"开发中，待接口完成先");
