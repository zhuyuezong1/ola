...
public class CartActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        lp.height = DisplayUtils.getStatusBarHeight2(CartActivity.this);
...
//                    ToastUtils.showLongToast(getApplicationContext(), "请求成功");
            ...
            public void onBusinessError(int code, String msg) {
                slLayout.setRefreshing(false);
                ToastUtils.showLongToast(CartActivity.this, msg);
            }
...
//        initData();
        cartAdapter = new CartAdapter(CartActivity.this, cartProductModels, adapterType);
