...
public class CommentManagerImageAdapter extends RecyclerView.Adapter {
    ...
    public CommentManagerImageAdapter(Context context, List<UserViewInfo> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new CommentImageViewHolder(LayoutInflater.from(context).inflate(R.layout.item_comment_manager_image,viewGroup,false));
    }
