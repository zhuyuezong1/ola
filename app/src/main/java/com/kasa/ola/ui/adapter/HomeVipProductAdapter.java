...
public class HomeVipProductAdapter extends RecyclerView.Adapter {
    ...
    public HomeVipProductAdapter(Context context,List<HomeBean.MallProductBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new HomeVipProductViewHolder(LayoutInflater.from(context).inflate(R.layout.item_vip,viewGroup,false));
    }
