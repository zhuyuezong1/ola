...
public class ProductClassifyAdapter extends RecyclerView.Adapter {
    ...
    public ProductClassifyAdapter(Context context, List<MallClassBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ProductClassifyViewHolder(LayoutInflater.from(context).inflate(R.layout.item_product_classify,viewGroup,false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ProductClassifyViewHolder holder = (ProductClassifyViewHolder) viewHolder;
...
//        return 9;
    ...
    private class ProductClassifyViewHolder extends RecyclerView.ViewHolder{
        ...
        public ProductClassifyViewHolder(@NonNull View itemView) {
            super(itemView);
