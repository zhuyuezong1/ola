...
public class ShopProductVerticalAdapter extends RecyclerView.Adapter {
    ...
    public ShopProductVerticalAdapter(Context context, List<ShopProductBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ShopProductVerticalViewHolder(LayoutInflater.from(context).inflate(R.layout.item_shop_vertical_product,viewGroup,false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ShopProductVerticalViewHolder holder = (ShopProductVerticalViewHolder) viewHolder;
...
//        return 2;
    ...
    private class ShopProductVerticalViewHolder extends RecyclerView.ViewHolder{
        ...
        public ShopProductVerticalViewHolder(@NonNull View itemView) {
            super(itemView);
