...
public class ProductCommentImageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ProductCommentImageViewHolder(LayoutInflater.from(context).inflate(R.layout.item_product_comment_image,viewGroup,false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        final ProductCommentImageViewHolder holder = (ProductCommentImageViewHolder) viewHolder;
...
//        return list==null?0:list.size();
    ...
    private class ProductCommentImageViewHolder extends RecyclerView.ViewHolder{
        private ImageView iv_comment_image;
        public ProductCommentImageViewHolder(@NonNull View itemView) {
            super(itemView);
