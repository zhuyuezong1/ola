...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2) {
		...
		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\"0.01\",\"subject\":\"1\",\"body\":\"购买\",\"out_trade_no\":\"" + getOutTradeNo()+  "\"}");
		...
		keyValues.put("timestamp", DateUtil.getCurrentTime());/*"2016-07-29 16:55:53"*/
