...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    private static final int REQUEST_CODE_SCAN_GALLERY = 0x0001;
...
//    private TranslateAnimation translateAnimation;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv_phono_album).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                back();
            }
...
//        intent.putExtra("selectPicture", "1");
...
//        finish();
    ...
    private void init() {
        ...
        tbLight.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    tvLight.setText("轻点关闭");
                    openFlashlight();
                } else {
                    tvLight.setText("轻点照亮");
                    closeFlashlight();
                }
            }
        });
    ...
    private void initScan() {
        ...
        objectAnimator = ObjectAnimator.ofFloat(scanLine, "translationY", curTranslationY, dp2px(this, 238));
